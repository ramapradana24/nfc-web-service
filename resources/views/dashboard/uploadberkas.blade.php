            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-md-8">
                    <div class="card card-outline-info">
                        ...
                        <div class="card-body">
                            <form method="POST" action="/registrasi/tahap3">
                                        ...
                                        <table class="table table-bordered m-t-20">
                                            ...
                                            @foreach($jenisberkas as $i => $row)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="/dashboard/uploadberkas/{{ $row->jenisberkas_id }}" class="btn btn-primary">
                            ...
                            <form id="formKembali" method="POST" action="/registrasi/kembali/tahap2">@csrf</form>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <p>: {{ Auth::user()->sekolah->sekolah_nama }}</p>
                    </div>
                </div>
                <hr class="m-t-0">
                <div class="row">
