...
d[c]=e,"o"===b[1]&&Y(a[e])});a._hungarianMap=d}function J(a,b,c){a._hungarianMap||Y(a);var d;h.each(b,function(e){d=a._hungarianMap[e];if(d!==k&&(c||b[d]===k))"o"===d.charAt(0)?(b[d]||(b[d]={}),h.extend(!0,b[d],b[e]),J(a[d],b[d],c)):b[d]=b[e]})}function Fa(a){var b=m.defaults.oLanguage,c=a.sZeroRecords;!a.sEmptyTable&&(c&&"Data kosong"===b.sEmptyTable)&&F(a,a,"sZeroRecords","sEmptyTable");!a.sLoadingRecords&&(c&&"Loading..."===b.sLoadingRecords)&&F(a,a,"sZeroRecords","sLoadingRecords");
...
sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"First",sLast:"Last",sNext:"Berikutnya",sPrevious:"Sebelumnya"},sEmptyTable:"Data kosong",sInfo:"Menampilkan _START_ - _END_ dari _TOTAL_",sInfoEmpty:"Menampilkan 0 - 0 dari 0",sInfoFiltered:"(ter-filter dari _MAX_ total baris)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Tampilkan _MENU_ baris",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"Filter :",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"No matching records found"},
